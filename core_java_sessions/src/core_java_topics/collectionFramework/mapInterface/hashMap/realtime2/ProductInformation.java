...
public class ProductInformation {
	...
	public static void main(String[] args) {
		...
		mapSamsung.put(111111l, prod1);
		mapSamsung.put(222222l, prod2);
		mapSamsung.put(222222l, prod3);
		...
		mapOppo.put(4444444l, prod4);
		mapOppo.put(5555555l, prod5);
		mapOppo.put(6666666l, prod6);
		...
		mapVivo.put(7777777l, prod7);
		mapVivo.put(8888888l, prod8);
